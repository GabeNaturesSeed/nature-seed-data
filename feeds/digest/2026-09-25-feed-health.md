# Feed Health — 2026-09-25

## Summary

| Channel | Coverage | Drift | Quality Issues |
|---|---|---|---|
| walmart | 200/604 | 214 | 200 |
...
| google_merchant | 416/604 | 267 | 95 |
| klaviyo | 305/604 | 188 | 19 |
| shopper_approved | 474/604 | 20 | 13 |
| reddit | 235/604 | 1 | 0 |
| facebook | 289/604 | 402 | 9 |
...
- [ ] **walmart**: sync price on `PB-DRY-50-LB-KIT` (WC: 216.71 | channel: 91.78)
...
- [ ] **walmart**: sync price on `TURF-CLV-5-LB` (WC: 22.99 | channel: 17.99)
- [ ] **walmart**: sync stock_status on `TURF-CLV-5-LB` (WC: onbackorder | channel: outofstock)
...
- [ ] **walmart**: sync stock_status on `PB-SHPR-20-LB-KIT` (WC: instock | channel: outofstock)
...
- [ ] **walmart**: sync stock_status on `PB-FULL-10-LB` (WC: onbackorder | channel: outofstock)
...
- [ ] **walmart**: sync stock_status on `PB-CHSS-2-LB-KIT` (WC: onbackorder | channel: outofstock)
...
- [ ] **walmart**: sync stock_status on `PB-COSS-1-LB-KIT` (WC: onbackorder | channel: outofstock)
...
- [ ] **walmart**: sync stock_status on `W-LUMI-0.25-LB` (WC: onbackorder | channel: outofstock)
...
- [ ] **walmart**: sync price on `PG-TRRE-5-LB` (WC: 39.99 | channel: 34.99)
- [ ] **walmart**: sync stock_status on `PG-TRRE-5-LB` (WC: onbackorder | channel: outofstock)
...
- [ ] **walmart**: sync stock_status on `S-RICE-45-LB` (WC: onbackorder | channel: outofstock)
...
- [ ] **walmart**: sync stock_status on `WB-CCN-0.5-LB` (WC: onbackorder | channel: outofstock)
- [ ] **walmart**: sync price on `WB-CCN-5-LB-KIT` (WC: 319.99 | channel: 284.39)
- [ ] **walmart**: sync stock_status on `WB-CCN-5-LB-KIT` (WC: onbackorder | channel: outofstock)
...
- [ ] **walmart**: sync stock_status on `S-MICRO-5-LB-KIT` (WC: onbackorder | channel: outofstock)
- [ ] **walmart**: sync stock_status on `S-MICRO-2-LB-KIT` (WC: onbackorder | channel: outofstock)
- [ ] **walmart**: sync stock_status on `S-MICRO-1-LB` (WC: onbackorder | channel: outofstock)
- [ ] **walmart**: sync stock_status on `S-INNOC-5-LB` (WC: instock | channel: outofstock)
- [ ] **walmart**: sync stock_status on `S-TACKI-50-LB` (WC: onbackorder | channel: outofstock)
...
- [ ] **walmart**: sync stock_status on `PG-SECE-5-LB` (WC: onbackorder | channel: outofstock)
- [ ] **walmart**: sync stock_status on `PG-SECE-25-LB-KIT` (WC: onbackorder | channel: outofstock)
- [ ] **walmart**: sync stock_status on `PG-SECE-50-LB-KIT` (WC: onbackorder | channel: outofstock)
...
- [ ] **walmart**: sync stock_status on `PG-POPR-25-LB-KIT` (WC: onbackorder | channel: outofstock)
...
- [ ] **walmart**: sync stock_status on `PG-FEAR2-50-LB-KIT` (WC: onbackorder | channel: outofstock)
- [ ] **walmart**: sync stock_status on `PG-FEAR2-25-LB-KIT` (WC: instock | channel: outofstock)
- [ ] **walmart**: sync stock_status on `S-FEOV-25-LB-KIT` (WC: onbackorder | channel: outofstock)
- [ ] **walmart**: sync stock_status on `S-FEOV-10-LB-KIT` (WC: onbackorder | channel: outofstock)
...
- [ ] **walmart**: sync stock_status on `S-DUTCH-25-LB-KIT` (WC: onbackorder | channel: outofstock)
- [ ] **walmart**: sync stock_status on `S-DUTCH-10-LB-KIT` (WC: onbackorder | channel: outofstock)
...
- [ ] **walmart**: 421 WC SKUs not listed — W-HEAN, W-HEAN-1-LB-KIT, W-HEAN-0.5-LB-KIT, W-HEAN-0.25-LB, PB-DOVE...
...
- [ ] **google_merchant**: sync stock_status on `PB-FULL-10-LB` (WC: onbackorder | channel: instock)
...
- [ ] **google_merchant**: sync stock_status on `PB-SHADE-10-LB` (WC: onbackorder | channel: instock)
- [ ] **google_merchant**: sync stock_status on `PB-CHSS-2-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **google_merchant**: sync stock_status on `PB-COSS-2-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **google_merchant**: sync stock_status on `PB-COSS-1-LB-KIT` (WC: onbackorder | channel: instock)
...
- [ ] **google_merchant**: sync stock_status on `W-SAAP-1-LB-KIT` (WC: onbackorder | channel: instock)
...
- [ ] **google_merchant**: sync stock_status on `W-NAPU-0.5-LB-KIT` (WC: onbackorder | channel: instock)
...
- [ ] **google_merchant**: sync stock_status on `W-LUMI-0.25-LB` (WC: onbackorder | channel: instock)
...
- [ ] **google_merchant**: sync stock_status on `W-SIBE-1-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **google_merchant**: sync stock_status on `W-SIBE-0.5-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **google_merchant**: sync stock_status on `W-SIBE-0.25-LB` (WC: onbackorder | channel: instock)
...
- [ ] **google_merchant**: sync price on `TURF-W-SS-25-LB-KIT` (WC: 149.99 | channel: 199.99)
...
- [ ] **google_merchant**: sync price on `TURF-NFF-50-LB-KIT` (WC: 1959.99 | channel: 2305.87)
...
- [ ] **google_merchant**: sync stock_status on `WB-CCN-0.5-LB` (WC: onbackorder | channel: instock)
- [ ] **google_merchant**: sync stock_status on `WB-CCN-1-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **google_merchant**: sync stock_status on `WB-CCN-5-LB-KIT` (WC: onbackorder | channel: instock)
...
- [ ] **google_merchant**: sync stock_status on `S-MICRO-5-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **google_merchant**: sync stock_status on `S-MICRO-2-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **google_merchant**: sync stock_status on `S-MICRO-1-LB` (WC: onbackorder | channel: instock)
- [ ] **google_merchant**: sync stock_status on `S-TACKI-50-LB` (WC: onbackorder | channel: instock)
...
- [ ] **google_merchant**: sync stock_status on `PG-SECE-5-LB` (WC: onbackorder | channel: instock)
- [ ] **google_merchant**: sync stock_status on `PG-SECE-25-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **google_merchant**: sync stock_status on `PG-SECE-50-LB-KIT` (WC: onbackorder | channel: instock)
...
- [ ] **google_merchant**: sync stock_status on `PG-POPR-25-LB-KIT` (WC: onbackorder | channel: instock)
...
- [ ] **google_merchant**: sync stock_status on `PG-FEAR2-50-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **google_merchant**: sync stock_status on `PG-FEAR2-5-LB` (WC: onbackorder | channel: instock)
- [ ] **google_merchant**: sync stock_status on `S-FEOV-5-LB` (WC: onbackorder | channel: instock)
- [ ] **google_merchant**: sync stock_status on `S-FEOV-25-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **google_merchant**: sync stock_status on `S-FEOV-10-LB-KIT` (WC: onbackorder | channel: instock)
...
- [ ] **google_merchant**: sync stock_status on `S-DUTCH-5-LB` (WC: onbackorder | channel: instock)
- [ ] **google_merchant**: sync price on `S-DUTCH-25-LB-KIT` (WC: 199.99 | channel: 292.19)
- [ ] **google_merchant**: sync stock_status on `S-DUTCH-25-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **google_merchant**: sync price on `S-DUTCH-10-LB-KIT` (WC: 79.98 | channel: 116.52)
- [ ] **google_merchant**: sync stock_status on `S-DUTCH-10-LB-KIT` (WC: onbackorder | channel: instock)
...
- [ ] **google_merchant**: sync price on `TURF-JBR-25-LB-KIT` (WC: 382.99 | channel: 449.95)
...
- [ ] **google_merchant**: sync price on `TURF-WSHD-25-LB-KIT` (WC: 169.99 | channel: 238.18)
...
- [ ] **google_merchant**: 304 WC SKUs not listed — W-HEAN, W-HEAN-1-LB-KIT, W-HEAN-0.5-LB-KIT, W-HEAN-0.25-LB, PB-DOVE...
...
- [ ] **klaviyo**: sync stock_status on `WB-JPW-5-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync stock_status on `TURF-CLV-5-LB` (WC: onbackorder | channel: instock)
...
- [ ] **klaviyo**: sync stock_status on `TURF-MLB-10-LB-KIT` (WC: onbackorder | channel: instock)
...
- [ ] **klaviyo**: sync stock_status on `PB-FULL-10-LB` (WC: onbackorder | channel: instock)
...
- [ ] **klaviyo**: sync stock_status on `PB-SHADE-10-LB` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync stock_status on `PB-CHSS-2-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync stock_status on `PB-COSS-2-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync stock_status on `PB-COSS-1-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync stock_status on `W-ENCA-1-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync price on `W-ENCA-0.5-LB-KIT` (WC: 38.10 | channel: 38.1)
- [ ] **klaviyo**: sync stock_status on `W-ENCA-0.25-LB` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync stock_status on `W-SAAP-1-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync stock_status on `W-SAAP-0.25-LB` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync stock_status on `W-NAPU-1-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync stock_status on `W-NAPU-0.5-LB-KIT` (WC: onbackorder | channel: instock)
...
- [ ] **klaviyo**: sync stock_status on `W-LUMI-0.25-LB` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync stock_status on `W-ACLA-1-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync stock_status on `W-ACLA-0.25-LB` (WC: onbackorder | channel: instock)
...
- [ ] **klaviyo**: sync stock_status on `W-SIBE-1-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync stock_status on `W-SIBE-0.5-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync stock_status on `W-SIBE-0.25-LB` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync stock_status on `PG-TRRE-50-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync stock_status on `PG-TRRE-5-LB` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync stock_status on `PG-TRRE-10-LB-KIT` (WC: onbackorder | channel: instock)
...
- [ ] **klaviyo**: sync stock_status on `CV-CHM-25-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync stock_status on `CV-CNEC-50-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync stock_status on `CV-CNEC-5-LB` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync stock_status on `CV-CNEC-25-LB-KIT` (WC: onbackorder | channel: instock)
...
- [ ] **klaviyo**: sync stock_status on `WB-CCN-0.5-LB` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync stock_status on `WB-CCN-1-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync stock_status on `WB-CCN-5-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync stock_status on `WB-CALN-0.5-LB` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync price on `WB-CALN-1-LB-KIT` (WC: 74.10 | channel: 74.1)
...
- [ ] **klaviyo**: sync stock_status on `S-MICRO-5-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync stock_status on `S-MICRO-2-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync stock_status on `S-MICRO-1-LB` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync stock_status on `S-TACKI-50-LB` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync stock_status on `PG-SECE-5-LB` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync stock_status on `PG-SECE-25-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync stock_status on `PG-SECE-50-LB-KIT` (WC: onbackorder | channel: instock)
...
- [ ] **klaviyo**: sync stock_status on `PG-POPR-25-LB-KIT` (WC: onbackorder | channel: instock)
...
- [ ] **klaviyo**: sync stock_status on `PG-FEAR2-50-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync stock_status on `PG-FEAR2-5-LB` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync stock_status on `S-FEOV-5-LB` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync stock_status on `S-FEOV-25-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync stock_status on `S-FEOV-10-LB-KIT` (WC: onbackorder | channel: instock)
...
- [ ] **klaviyo**: sync stock_status on `S-DUTCH-5-LB` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync stock_status on `S-DUTCH-25-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync stock_status on `S-DUTCH-10-LB-KIT` (WC: onbackorder | channel: instock)
...
- [ ] **klaviyo**: sync stock_status on `TURF-W-TALL-10-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync stock_status on `TURF-W-TALL-25-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **klaviyo**: sync stock_status on `TURF-W-TALL-5-LB` (WC: onbackorder | channel: instock)
...
- [ ] **klaviyo**: 340 WC SKUs not listed — W-HEAN, W-HEAN-1-LB-KIT, W-HEAN-0.5-LB-KIT, W-HEAN-0.25-LB, PB-DOVE...
...
- [ ] **klaviyo**: `PG-TRHY-50-LB-KIT` missing fields: main_image_url
- [ ] **klaviyo**: `PG-TRIN-50-LB-KIT` missing fields: main_image_url
...
- [ ] **shopper_approved**: sync stock_status on `S-TACKI-50-LB` (WC: onbackorder | channel: instock)
...
- [ ] **shopper_approved**: 575 WC SKUs not listed — W-HEAN, W-HEAN-1-LB-KIT, W-HEAN-0.5-LB-KIT, W-HEAN-0.25-LB, PB-DOVE...
...
- [ ] **reddit**: 369 WC SKUs not listed — W-HEAN, PB-DOVE, WB-PERCUT, WB-COTTAGE, WB-SUNSET...
...
- [ ] **facebook**: sync stock_status on `PB-SHPR-20-LB-KIT` (WC: instock | channel: outofstock)
...
- [ ] **facebook**: sync stock_status on `PB-FULL-10-LB` (WC: onbackorder | channel: outofstock)
...
- [ ] **facebook**: sync stock_status on `PB-SHADE-10-LB` (WC: onbackorder | channel: outofstock)
...
- [ ] **facebook**: sync stock_status on `PB-CHSS-2-LB-KIT` (WC: onbackorder | channel: instock)
...
- [ ] **facebook**: sync stock_status on `PB-COSS-1-LB-KIT` (WC: onbackorder | channel: instock)
...
- [ ] **facebook**: sync stock_status on `W-SAAP-1-LB-KIT` (WC: onbackorder | channel: instock)
...
- [ ] **facebook**: sync stock_status on `W-NAPU-0.5-LB-KIT` (WC: onbackorder | channel: instock)
...
- [ ] **facebook**: sync stock_status on `W-LUMI-0.25-LB` (WC: onbackorder | channel: instock)
...
- [ ] **facebook**: sync stock_status on `W-SIBE-1-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **facebook**: sync price on `W-SIBE-0.5-LB-KIT` (WC: 91.04 | channel: 101.15)
- [ ] **facebook**: sync stock_status on `W-SIBE-0.5-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **facebook**: sync stock_status on `W-SIBE-0.25-LB` (WC: onbackorder | channel: instock)
...
- [ ] **facebook**: sync stock_status on `WB-CCN-0.5-LB` (WC: onbackorder | channel: instock)
- [ ] **facebook**: sync price on `WB-CCN-1-LB-KIT` (WC: 67.74 | channel: 75.27)
- [ ] **facebook**: sync stock_status on `WB-CCN-1-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **facebook**: sync price on `WB-CCN-5-LB-KIT` (WC: 319.99 | channel: 376.46)
- [ ] **facebook**: sync stock_status on `WB-CCN-5-LB-KIT` (WC: onbackorder | channel: instock)
...
- [ ] **facebook**: sync stock_status on `S-MICRO-5-LB-KIT` (WC: onbackorder | channel: outofstock)
- [ ] **facebook**: sync price on `S-MICRO-2-LB-KIT` (WC: 79.99 | channel: 89.99)
- [ ] **facebook**: sync stock_status on `S-MICRO-2-LB-KIT` (WC: onbackorder | channel: outofstock)
- [ ] **facebook**: sync stock_status on `S-MICRO-1-LB` (WC: onbackorder | channel: instock)
- [ ] **facebook**: sync stock_status on `S-TACKI-50-LB` (WC: onbackorder | channel: instock)
...
- [ ] **facebook**: sync stock_status on `PG-SECE-5-LB` (WC: onbackorder | channel: instock)
- [ ] **facebook**: sync price on `PG-SECE-25-LB-KIT` (WC: 117.99 | channel: 124.95)
- [ ] **facebook**: sync stock_status on `PG-SECE-25-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **facebook**: sync price on `PG-SECE-50-LB-KIT` (WC: 210.99 | channel: 249.9)
- [ ] **facebook**: sync stock_status on `PG-SECE-50-LB-KIT` (WC: onbackorder | channel: instock)
...
- [ ] **facebook**: sync stock_status on `PG-POPR-25-LB-KIT` (WC: onbackorder | channel: instock)
...
- [ ] **facebook**: sync price on `PG-DAGL-50-LB-KIT` (WC: 424.99 | channel: 349.99)
- [ ] **facebook**: sync stock_status on `PG-DAGL-50-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **facebook**: sync price on `PG-DAGL-25-LB-KIT` (WC: 212.99 | channel: 174.99)
- [ ] **facebook**: sync stock_status on `PG-DAGL-25-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **facebook**: sync price on `PG-DAGL-5-LB` (WC: 42.99 | channel: 34.99)
...
- [ ] **facebook**: sync stock_status on `PG-FEAR2-50-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **facebook**: sync price on `PG-FEAR2-25-LB-KIT` (WC: 164.99 | channel: 174.99)
- [ ] **facebook**: sync stock_status on `PG-FEAR2-5-LB` (WC: onbackorder | channel: instock)
- [ ] **facebook**: sync price on `S-FEOV-5-LB` (WC: 39.99 | channel: 49.99)
- [ ] **facebook**: sync stock_status on `S-FEOV-5-LB` (WC: onbackorder | channel: instock)
- [ ] **facebook**: sync price on `S-FEOV-25-LB-KIT` (WC: 149.99 | channel: 249.95)
- [ ] **facebook**: sync stock_status on `S-FEOV-25-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **facebook**: sync price on `S-FEOV-10-LB-KIT` (WC: 69.99 | channel: 99.98)
- [ ] **facebook**: sync stock_status on `S-FEOV-10-LB-KIT` (WC: onbackorder | channel: instock)
...
- [ ] **facebook**: sync stock_status on `S-DUTCH-5-LB` (WC: onbackorder | channel: instock)
- [ ] **facebook**: sync price on `S-DUTCH-25-LB-KIT` (WC: 199.99 | channel: 224.95)
- [ ] **facebook**: sync stock_status on `S-DUTCH-25-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **facebook**: sync price on `S-DUTCH-10-LB-KIT` (WC: 79.98 | channel: 89.99)
- [ ] **facebook**: sync stock_status on `S-DUTCH-10-LB-KIT` (WC: onbackorder | channel: instock)
...
- [ ] **facebook**: 348 WC SKUs not listed — W-HEAN, W-HEAN-1-LB-KIT, W-HEAN-0.5-LB-KIT, W-HEAN-0.25-LB, PB-DOVE...
...
## Feed Scorecard — Week 39 (Slow Period, index 0.53)

| Channel | Coverage | Quality | Drift | Trend |
|---------|----------|---------|-------|-------|
| walmart | 100 🟢 | 0 🔴 | 0 🔴 | → |
| amazon | — | — | — | ERROR |
| google_merchant | 100 🟢 | 77 🔴 | 0 🔴 | → |
| klaviyo | 100 🟢 | 94 🟡 | 7 🔴 | → |
