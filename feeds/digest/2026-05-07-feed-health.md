...
- [ ] **walmart**: sync stock_status on `W-NAPU-1-LB-KIT` (WC: instock | channel: outofstock)
...
- [ ] **walmart**: sync stock_status on `PB-SHEP-TR-10-LB` (WC: onbackorder | channel: outofstock)
...
- [ ] **walmart**: `W-ENCA-1-LB-KIT` missing fields: short_description, main_image_url
...
- [ ] **walmart**: `TURF-MLB-10-LB-KIT` missing fields: short_description, main_image_url
