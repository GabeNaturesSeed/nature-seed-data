...
- [ ] **walmart**: sync stock_status on `WB-DR-5-LB-KIT` (WC: onbackorder | channel: outofstock)
...
- [ ] **walmart**: sync stock_status on `TURF-FINE-10-LB-KIT` (WC: onbackorder | channel: outofstock)
...
- [ ] **walmart**: `TURF-W-BLUE-25-LB-KIT` missing fields: short_description, main_image_url
