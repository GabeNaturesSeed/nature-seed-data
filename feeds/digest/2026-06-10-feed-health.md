...
- [ ] **walmart**: `TURF-W-BR-10-LB-KIT` missing fields: short_description, main_image_url
...
- [ ] **google_merchant**: sync price on `PG-TRHY-25-LB-KIT` (WC: 108.79 | channel: 161.59)
- [ ] **google_merchant**: sync price on `PG-TRHY-10-LB-KIT` (WC: 45.89 | channel: 64.18)
...
- [ ] **klaviyo**: sync price on `PG-TRHY-5-LB` (WC: 30.99 | channel: None)
...
## Feed Scorecard — Week 24 (Deep Off-Season, index 0.30)
