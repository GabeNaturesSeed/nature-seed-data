# Feed Health — 2026-05-06

## Summary

| Channel | Coverage | Drift | Quality Issues |
|---|---|---|---|
| walmart | 200/478 | 193 | 200 |
| amazon | ERROR | ERROR | 401 Client Error: Unauthorized for url: https://api.amazon.com/auth/o2/token |
| google_merchant | 319/478 | 144 | 16 |
| klaviyo | 305/478 | 405 | 30 |
| shopper_approved | 474/478 | 21 | 13 |
| reddit | 181/478 | 2 | 0 |
| facebook | 280/478 | 332 | 9 |
...
- [ ] **walmart**: 293 WC SKUs not listed — W-TRDA, W-TRDA-1-LB-KIT, W-TRDA-0.5-LB-KIT, W-TRDA-0.25-LB, W-LUTE...
- [ ] **walmart**: `PG-TRRE-10-LB-KIT` missing fields: short_description, main_image_url
- [ ] **walmart**: `PB-HRSE-SO-20-LB-KIT` missing fields: short_description, main_image_url
- [ ] **walmart**: `PG-FEAR2-25-LB-KIT` missing fields: short_description, main_image_url
...
- [ ] **amazon**: investigate error — 401 Client Error: Unauthorized for url: https://api.amazon.com/auth/o2/token
...
- [ ] **google_merchant**: sync price on `PB-SGPR-20-LB-KIT` (WC: 392.39 | channel: 288.98)
...
- [ ] **google_merchant**: sync stock_status on `PB-COSS-1-LB-KIT` (WC: instock | channel: outofstock)
...
- [ ] **google_merchant**: sync price on `S-DUTCH-25-LB-KIT` (WC: 199.99 | channel: 224.95)
...
- [ ] **google_merchant**: sync price on `TURF-FINE-5-LB` (WC: 39.99 | channel: 69.99)
...
- [ ] **google_merchant**: sync stock_status on `PG-TRIN-25-LB-KIT` (WC: outofstock | channel: instock)
...
- [ ] **google_merchant**: 172 WC SKUs not listed — W-TRDA, W-LUTE, WB-TEXN, TURF-TXN, WB-TXPB...
...
- [ ] **klaviyo**: sync stock_status on `PB-KRMU-50-LB-KIT` (WC: onbackorder | channel: instock)
...
- [ ] **klaviyo**: sync stock_status on `PG-TRRE-5-LB` (WC: onbackorder | channel: instock)
...
- [ ] **klaviyo**: sync stock_status on `CV-CNEC-50-LB-KIT` (WC: onbackorder | channel: instock)
...
- [ ] **klaviyo**: sync stock_status on `WB-SD-0.5-LB` (WC: onbackorder | channel: instock)
...
- [ ] **reddit**: sync stock_status on `TURF-BUDA-3-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **reddit**: sync stock_status on `CV-CNEC-50-LB-KIT` (WC: onbackorder | channel: instock)
- [ ] **reddit**: 297 WC SKUs not listed — W-TRDA, W-LUTE, WB-TEXN, TURF-TXN, WB-TXPB...
...
## Feed Scorecard — Week 19 (Deep Off-Season, index 0.54)

| Channel | Coverage | Quality | Drift | Trend |
|---------|----------|---------|-------|-------|
| walmart | 100 🟢 | 0 🔴 | 0 🔴 | → |
| amazon | — | — | — | ERROR |
| google_merchant | 100 🟢 | 95 🟢 | 32 🔴 | → |
| klaviyo | 100 🟢 | 90 🟡 | 0 🔴 | → |
