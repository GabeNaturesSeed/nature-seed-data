# Feed Health — 2026-09-26

## Summary

| Channel | Coverage | Drift | Quality Issues |
|---|---|---|---|
| walmart | 200/604 | 215 | 200 |
...
| google_merchant | 416/604 | 266 | 95 |
...
- [ ] **walmart**: sync stock_status on `PB-SHADE-10-LB` (WC: onbackorder | channel: outofstock)
...
- [ ] **walmart**: sync stock_status on `W-NAPU-0.5-LB-KIT` (WC: onbackorder | channel: outofstock)
...
- [ ] **walmart**: sync stock_status on `S-FEOV-5-LB` (WC: onbackorder | channel: outofstock)
...
- [ ] **walmart**: 420 WC SKUs not listed — W-HEAN, W-HEAN-1-LB-KIT, W-HEAN-0.5-LB-KIT, W-HEAN-0.25-LB, PB-DOVE...
...
- [ ] **reddit**: 368 WC SKUs not listed — W-HEAN, PB-DOVE, WB-PERCUT, WB-COTTAGE, WB-SUNSET...
...
## Feed Scorecard — Week 39 (Average, index 0.53)
