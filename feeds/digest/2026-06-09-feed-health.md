...
- [ ] **walmart**: `PB-BIRD-20-LB-KIT` missing fields: short_description, main_image_url
- [ ] **walmart**: `PG-DAGL-25-LB-KIT` missing fields: short_description, main_image_url
- [ ] **walmart**: `W-ACLA-0.5-LB-KIT` missing fields: short_description, main_image_url
...
## Feed Scorecard — Week 24 (Average, index 0.30)
...
_Off-season (Average): coverage expectations relaxed. Quality held to full standard._
