...
| google_merchant | 319/478 | 147 | 16 |
...
- [ ] **walmart**: sync stock_status on `TURF-W-SS-5-LB` (WC: instock | channel: outofstock)
...
- [ ] **walmart**: `S-FEOV-25-LB-KIT` missing fields: short_description, main_image_url
...
- [ ] **walmart**: `PB-CHIX-25-LB-KIT` missing fields: short_description, main_image_url
