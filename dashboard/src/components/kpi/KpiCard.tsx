...
export default function KpiCard({ label, value, badges, note }: KpiCardProps) {
  return (
    <div className="bg-surface-lowest rounded-xl shadow-ambient p-5">
      <p className="text-xs uppercase tracking-wider text-brand-neutral/50 mb-2">{label}</p>
      <p className="text-3xl font-semibold text-brand-neutral mb-2.5 leading-none">{value}</p>
