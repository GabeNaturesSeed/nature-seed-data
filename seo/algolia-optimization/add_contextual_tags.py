...
# NOTE: Free plan rule limit is 10. Additional no-catalog redirects are
# implemented as oneWaySynonyms in optimize_search.py SYNONYMS_V2 list.
# These include: globemallow, goldenrod, lespedeza, chamomile, gypsum,
# coconut coir, muhly grass, lemon mint, tidytips, daikon radish,
# duckweed, mushroom, sacaton, african daisy, dymondia, gourd, soybean,
# sweet woodruff, centipede grass. See syn-redirect-* entries.
